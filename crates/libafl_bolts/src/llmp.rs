    ...
    SP: ShMemProvider<ShMem = SHM>,
{
    ...
    /// Acquired with [`describe`](Self::describe).
    ...
    SP: ShMemProvider<ShMem = SHM>,
{
    ...
    /// Returns the id of the new client in the `client_shmem` field
    ...
    SP: ShMemProvider<ShMem = SHM>,
{
    ...
    /// Recreate this client from a previous [`to_env`](Self::to_env) call
    #[cfg(feature = "std")]
