...
- `cxxbridge-cmd@=1.0.190` (needs to match version in tinyinst-rs) to generate bridge files between Rust and c++, you can install this with `cargo install cxxbridge-cmd@=1.0.190`.
