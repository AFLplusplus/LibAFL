...
impl Default for PatchedHooks {
    fn default() -> Self {
        Self { hooks: [
            ...
            PatchedHook::new::<unsafe extern "C" fn(*mut c_void)>(
                c"free",
                hooks::free::free,
            ),
            PatchedHook::new::<unsafe extern "C" fn(*mut c_void) -> size_t>(
                c"malloc_usable_size",
                hooks::malloc_usable_size::malloc_usable_size,
            ),
            PatchedHook::new::<unsafe extern "C" fn(size_t, size_t) -> *mut c_void>(
                c"memalign",
                hooks::memalign::memalign,
            ),
            PatchedHook::new::<unsafe extern "C" fn(*mut *mut c_void, size_t, size_t) -> c_int>(
                c"posix_memalign",
                hooks::posix_memalign::posix_memalign,
            ),
            PatchedHook::new::<unsafe extern "C" fn(size_t) -> *mut c_void>(
                c"pvalloc",
                hooks::pvalloc::pvalloc,
            ),
            PatchedHook::new::<unsafe extern "C" fn(*mut c_void, size_t) -> *mut c_void>(
                c"realloc",
                hooks::realloc::realloc,
            ),
            PatchedHook::new::<unsafe extern "C" fn(*mut c_void, size_t, size_t) -> *mut c_void>(
                c"reallocarray",
                hooks::reallocarray::reallocarray,
            ),
            PatchedHook::new::<unsafe extern "C" fn(size_t) -> *mut c_void>(
                c"valloc",
                hooks::valloc::valloc,
