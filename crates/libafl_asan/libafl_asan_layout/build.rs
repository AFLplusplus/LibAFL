...
use crate::{GuestAddr, ShadowLayout};
...
#[unsafe(no_mangle)]
#[used]
pub static libafl_shadow_base: usize = {shadow_base};
...
fn find_max_vaddr_bits<const NB_TRIES: usize>() -> usize {
    ...
    let mut bits_min: usize = page_size.trailing_zeros() as usize;
    let mut bits_max: usize = usize::BITS as usize;
...
fn main() {
    if env::var_os("CARGO_FEATURE_DYNAMIC_LAYOUT").is_none() {
        return;
    }
