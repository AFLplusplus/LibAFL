/* 1.92.0-nightly */
/* qemu git hash: b6884369419cd439c7133ef7fada4c336354a0c3 */
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of CPUArchState"][::std::mem::size_of::<CPUArchState>() - 15104usize];
    ...
    ["Offset of field: CPUArchState::mcg_cap"]
        [::std::mem::offset_of!(CPUArchState, mcg_cap) - 14696usize];
    ["Offset of field: CPUArchState::mcg_ctl"]
        [::std::mem::offset_of!(CPUArchState, mcg_ctl) - 14704usize];
    ["Offset of field: CPUArchState::mcg_ext_ctl"]
        [::std::mem::offset_of!(CPUArchState, mcg_ext_ctl) - 14712usize];
    ["Offset of field: CPUArchState::mce_banks"]
        [::std::mem::offset_of!(CPUArchState, mce_banks) - 14720usize];
    ["Offset of field: CPUArchState::xstate_bv"]
        [::std::mem::offset_of!(CPUArchState, xstate_bv) - 15040usize];
    ["Offset of field: CPUArchState::fpus_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fpus_vmstate) - 15048usize];
    ["Offset of field: CPUArchState::fptag_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fptag_vmstate) - 15050usize];
    ["Offset of field: CPUArchState::fpregs_format_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fpregs_format_vmstate) - 15052usize];
    ["Offset of field: CPUArchState::xss"][::std::mem::offset_of!(CPUArchState, xss) - 15056usize];
    ["Offset of field: CPUArchState::umwait"]
        [::std::mem::offset_of!(CPUArchState, umwait) - 15064usize];
    ["Offset of field: CPUArchState::tpr_access_type"]
        [::std::mem::offset_of!(CPUArchState, tpr_access_type) - 15068usize];
    ["Offset of field: CPUArchState::topo_info"]
        [::std::mem::offset_of!(CPUArchState, topo_info) - 15072usize];
    ["Offset of field: CPUArchState::avail_cpu_topo"]
        [::std::mem::offset_of!(CPUArchState, avail_cpu_topo) - 15088usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ArchCPU"][::std::mem::size_of::<ArchCPU>() - 26944usize];
    ...
    ["Offset of field: ArchCPU::vmsentry"][::std::mem::offset_of!(ArchCPU, vmsentry) - 26304usize];
    ["Offset of field: ArchCPU::ucode_rev"]
        [::std::mem::offset_of!(ArchCPU, ucode_rev) - 26312usize];
    ["Offset of field: ArchCPU::hyperv_spinlock_attempts"]
        [::std::mem::offset_of!(ArchCPU, hyperv_spinlock_attempts) - 26320usize];
    ["Offset of field: ArchCPU::hyperv_vendor"]
        [::std::mem::offset_of!(ArchCPU, hyperv_vendor) - 26328usize];
    ["Offset of field: ArchCPU::hyperv_synic_kvm_only"]
        [::std::mem::offset_of!(ArchCPU, hyperv_synic_kvm_only) - 26336usize];
    ["Offset of field: ArchCPU::hyperv_features"]
        [::std::mem::offset_of!(ArchCPU, hyperv_features) - 26344usize];
    ["Offset of field: ArchCPU::hyperv_passthrough"]
        [::std::mem::offset_of!(ArchCPU, hyperv_passthrough) - 26352usize];
    ["Offset of field: ArchCPU::hyperv_no_nonarch_cs"]
        [::std::mem::offset_of!(ArchCPU, hyperv_no_nonarch_cs) - 26356usize];
    ["Offset of field: ArchCPU::hyperv_vendor_id"]
        [::std::mem::offset_of!(ArchCPU, hyperv_vendor_id) - 26360usize];
    ["Offset of field: ArchCPU::hyperv_interface_id"]
        [::std::mem::offset_of!(ArchCPU, hyperv_interface_id) - 26372usize];
    ["Offset of field: ArchCPU::hyperv_limits"]
        [::std::mem::offset_of!(ArchCPU, hyperv_limits) - 26388usize];
    ["Offset of field: ArchCPU::hyperv_enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, hyperv_enforce_cpuid) - 26400usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_build"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_build) - 26404usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_major"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_major) - 26408usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_minor"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_minor) - 26410usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sp"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sp) - 26412usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sb"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sb) - 26416usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sn"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sn) - 26420usize];
    ["Offset of field: ArchCPU::check_cpuid"]
        [::std::mem::offset_of!(ArchCPU, check_cpuid) - 26424usize];
    ["Offset of field: ArchCPU::enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, enforce_cpuid) - 26425usize];
    ["Offset of field: ArchCPU::force_features"]
        [::std::mem::offset_of!(ArchCPU, force_features) - 26426usize];
    ["Offset of field: ArchCPU::expose_kvm"]
        [::std::mem::offset_of!(ArchCPU, expose_kvm) - 26427usize];
    ["Offset of field: ArchCPU::expose_tcg"]
        [::std::mem::offset_of!(ArchCPU, expose_tcg) - 26428usize];
    ["Offset of field: ArchCPU::migratable"]
        [::std::mem::offset_of!(ArchCPU, migratable) - 26429usize];
    ["Offset of field: ArchCPU::migrate_smi_count"]
        [::std::mem::offset_of!(ArchCPU, migrate_smi_count) - 26430usize];
    ["Offset of field: ArchCPU::max_features"]
        [::std::mem::offset_of!(ArchCPU, max_features) - 26431usize];
    ["Offset of field: ArchCPU::apic_id"][::std::mem::offset_of!(ArchCPU, apic_id) - 26432usize];
    ["Offset of field: ArchCPU::vmware_cpuid_freq"]
        [::std::mem::offset_of!(ArchCPU, vmware_cpuid_freq) - 26436usize];
    ["Offset of field: ArchCPU::cache_info_passthrough"]
        [::std::mem::offset_of!(ArchCPU, cache_info_passthrough) - 26437usize];
    ["Offset of field: ArchCPU::mwait"][::std::mem::offset_of!(ArchCPU, mwait) - 26440usize];
    ["Offset of field: ArchCPU::filtered_features"]
        [::std::mem::offset_of!(ArchCPU, filtered_features) - 26456usize];
    ["Offset of field: ArchCPU::enable_pmu"]
        [::std::mem::offset_of!(ArchCPU, enable_pmu) - 26800usize];
    ["Offset of field: ArchCPU::lbr_fmt"][::std::mem::offset_of!(ArchCPU, lbr_fmt) - 26808usize];
    ["Offset of field: ArchCPU::enable_lmce"]
        [::std::mem::offset_of!(ArchCPU, enable_lmce) - 26816usize];
    ["Offset of field: ArchCPU::enable_l3_cache"]
        [::std::mem::offset_of!(ArchCPU, enable_l3_cache) - 26817usize];
    ["Offset of field: ArchCPU::l1_cache_per_core"]
        [::std::mem::offset_of!(ArchCPU, l1_cache_per_core) - 26818usize];
    ["Offset of field: ArchCPU::legacy_cache"]
        [::std::mem::offset_of!(ArchCPU, legacy_cache) - 26819usize];
    ["Offset of field: ArchCPU::legacy_multi_node"]
        [::std::mem::offset_of!(ArchCPU, legacy_multi_node) - 26820usize];
    ["Offset of field: ArchCPU::enable_cpuid_0xb"]
        [::std::mem::offset_of!(ArchCPU, enable_cpuid_0xb) - 26821usize];
    ["Offset of field: ArchCPU::full_cpuid_auto_level"]
        [::std::mem::offset_of!(ArchCPU, full_cpuid_auto_level) - 26822usize];
    ["Offset of field: ArchCPU::vendor_cpuid_only"]
        [::std::mem::offset_of!(ArchCPU, vendor_cpuid_only) - 26823usize];
    ["Offset of field: ArchCPU::amd_topoext_features_only"]
        [::std::mem::offset_of!(ArchCPU, amd_topoext_features_only) - 26824usize];
    ["Offset of field: ArchCPU::intel_pt_auto_level"]
        [::std::mem::offset_of!(ArchCPU, intel_pt_auto_level) - 26825usize];
    ["Offset of field: ArchCPU::fill_mtrr_mask"]
        [::std::mem::offset_of!(ArchCPU, fill_mtrr_mask) - 26826usize];
    ["Offset of field: ArchCPU::host_phys_bits"]
        [::std::mem::offset_of!(ArchCPU, host_phys_bits) - 26827usize];
    ["Offset of field: ArchCPU::host_phys_bits_limit"]
        [::std::mem::offset_of!(ArchCPU, host_phys_bits_limit) - 26828usize];
    ["Offset of field: ArchCPU::kvm_pv_enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, kvm_pv_enforce_cpuid) - 26829usize];
    ["Offset of field: ArchCPU::phys_bits"]
        [::std::mem::offset_of!(ArchCPU, phys_bits) - 26832usize];
    ["Offset of field: ArchCPU::guest_phys_bits"]
        [::std::mem::offset_of!(ArchCPU, guest_phys_bits) - 26836usize];
    ["Offset of field: ArchCPU::apic_state"]
        [::std::mem::offset_of!(ArchCPU, apic_state) - 26840usize];
    ["Offset of field: ArchCPU::cpu_as_root"]
        [::std::mem::offset_of!(ArchCPU, cpu_as_root) - 26848usize];
    ["Offset of field: ArchCPU::cpu_as_mem"]
        [::std::mem::offset_of!(ArchCPU, cpu_as_mem) - 26856usize];
    ["Offset of field: ArchCPU::smram"][::std::mem::offset_of!(ArchCPU, smram) - 26864usize];
    ["Offset of field: ArchCPU::machine_done"]
        [::std::mem::offset_of!(ArchCPU, machine_done) - 26872usize];
    ["Offset of field: ArchCPU::kvm_msr_buf"]
        [::std::mem::offset_of!(ArchCPU, kvm_msr_buf) - 26896usize];
    ["Offset of field: ArchCPU::node_id"][::std::mem::offset_of!(ArchCPU, node_id) - 26904usize];
    ["Offset of field: ArchCPU::socket_id"]
        [::std::mem::offset_of!(ArchCPU, socket_id) - 26908usize];
    ["Offset of field: ArchCPU::die_id"][::std::mem::offset_of!(ArchCPU, die_id) - 26912usize];
    ["Offset of field: ArchCPU::module_id"]
        [::std::mem::offset_of!(ArchCPU, module_id) - 26916usize];
    ["Offset of field: ArchCPU::core_id"][::std::mem::offset_of!(ArchCPU, core_id) - 26920usize];
    ["Offset of field: ArchCPU::thread_id"]
        [::std::mem::offset_of!(ArchCPU, thread_id) - 26924usize];
    ["Offset of field: ArchCPU::hv_max_vps"]
        [::std::mem::offset_of!(ArchCPU, hv_max_vps) - 26928usize];
    ["Offset of field: ArchCPU::xen_vapic"]
        [::std::mem::offset_of!(ArchCPU, xen_vapic) - 26932usize];
};
