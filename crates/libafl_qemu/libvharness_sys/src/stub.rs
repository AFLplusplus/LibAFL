...
pub const LQEMU_WORD_SIZE: u32 = 64;
...
pub type __cfloat128 = __BindgenComplex<f64>;
...
unsafe extern "C" {
    pub fn _lqemu_custom_insn_call0(cmd: lqword) -> lqword;
}
unsafe extern "C" {
    pub fn _lqemu_custom_insn_call1(cmd: lqword, arg1: lqword) -> lqword;
}
unsafe extern "C" {
    pub fn _lqemu_custom_insn_call2(cmd: lqword, arg1: lqword, arg2: lqword) -> lqword;
}
unsafe extern "C" {
    pub fn _lqemu_backdoor_call0(cmd: lqword) -> lqword;
}
unsafe extern "C" {
    pub fn _lqemu_backdoor_call1(cmd: lqword, arg1: lqword) -> lqword;
}
unsafe extern "C" {
    pub fn _lqemu_backdoor_call2(cmd: lqword, arg1: lqword, arg2: lqword) -> lqword;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn libafl_qemu_version() -> lqword;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn libafl_qemu_trace_vaddr_range(start: lqword, end: lqword);
}
unsafe extern "C" {
    pub fn libafl_qemu_trace_vaddr_size(start: lqword, size: lqword);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn libafl_qemu_set_covmap_phys(paddr: *mut ::std::os::raw::c_char, len: lqword);
}
unsafe extern "C" {
