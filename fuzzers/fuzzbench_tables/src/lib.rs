...
fn fuzz(
    ...
    let tables_observer =
        ConstMapObserver::<u8, TABLES_MAP_SIZE>::new("tables", unsafe { &mut TABLES_MAP });
    ...
    let tables_feedback = MaxMapFeedback::new(&tables_observer);
    ...
    let mut executor = TimeoutExecutor::new(
        InProcessExecutor::new(
            &mut harness,
            tuple_list!(edges_observer, tables_observer, time_observer),
            &mut fuzzer,
            &mut state,
            &mut mgr,
        )?,
