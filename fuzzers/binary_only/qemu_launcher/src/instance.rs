...
impl<M: Monitor> Instance<'_, M> {
    ...
    fn reset_executor_snapshot_module<'a, C, CM, ED, ET, H, I, OT, S, SM>(
        executor: &mut QemuExecutor<'a, C, CM, ED, (SnapshotModule, ET), H, I, OT, S, SM>,
        qemu: Qemu,
    ) where
        I: Input + Unpin,
    ...
    fn reset_shadow_executor_snapshot_module<'a, C, CM, ED, ET, H, I, OT, S, SM, SOT>(
        executor: &mut ShadowExecutor<
            QemuExecutor<'a, C, CM, ED, (SnapshotModule, ET), H, I, OT, S, SM>,
            I,
            S,
            SOT,
        >,
