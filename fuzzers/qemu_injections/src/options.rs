...
pub struct FuzzerOptions {
    ...
    #[arg(short = 'x', long = "tokens", help = "Tokens file")]
    pub tokens: Option<String>,

    #[arg(short = 'y', long = "yaml", help = "Yaml file")]
    pub yamlfile: String,

    #[arg(long, help = "Log file")]
    pub log: Option<String>,

    #[arg(short, long, help = "Timeout in milli-seconds", default_value = "1000", value_parser = FuzzerOptions::parse_timeout)]
    pub timeout: Duration,

    #[arg(short, long = "port", help = "Broker port", default_value_t = 1337_u16)]
    pub port: u16,

    #[arg(short, long, help = "Cpu cores to use", default_value = "1"/*"all"*/, value_parser = Cores::from_cmdline)]
    pub cores: Cores,

    #[arg(long, help = "Cpu cores to use to use for ASAN", /*default_value = "0",*/ value_parser = Cores::from_cmdline)]
    pub asan_cores: Option<Cores>,

    #[arg(long, help = "Cpu cores to use to use for CmpLog", /*default_value = "0",*/ value_parser = Cores::from_cmdline)]
...
impl FuzzerOptions {
    ...
    pub fn get_yaml_file(&self) -> &str {
        self.yamlfile.as_ref()
    }
