...
pub use tracers::{
    trace_block_transition_hitcount, trace_block_transition_single, trace_edge_hitcount_ptr,
    trace_edge_single, trace_edge_single_ptr,
};
        ...
        V: EdgeCoverageVariant<AF, PF, IS_CONST_MAP, MAP_SIZE>,
    {
            ...
            emulator_modules.get::<EdgeCoverageModule<AF, PF, V, IS_CONST_MAP, MAP_SIZE>>()
        {
            unsafe {
                ...
                if !IS_CONST_MAP {
                    let edges_map_size_ptr = LIBAFL_QEMU_EDGES_MAP_SIZE_PTR;
