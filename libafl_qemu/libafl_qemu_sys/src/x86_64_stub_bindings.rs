...
#[test]
fn bindgen_test_layout_libafl_exit_reason_timeout() {
    assert_eq!(
        ::std::mem::size_of::<libafl_exit_reason_timeout>(),
        0usize,
        concat!("Size of: ", stringify!(libafl_exit_reason_timeout))
    );
    assert_eq!(
        ::std::mem::align_of::<libafl_exit_reason_timeout>(),
        1usize,
        concat!("Alignment of ", stringify!(libafl_exit_reason_timeout))
    );
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[test]
fn bindgen_test_layout_libafl_instruction_hook() {
    const UNINIT: ::std::mem::MaybeUninit<libafl_instruction_hook> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<libafl_instruction_hook>(),
        120usize,
        concat!("Size of: ", stringify!(libafl_instruction_hook))
    );
    assert_eq!(
        ::std::mem::align_of::<libafl_instruction_hook>(),
        8usize,
        concat!("Alignment of ", stringify!(libafl_instruction_hook))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(libafl_instruction_hook),
            "::",
            stringify!(data)
        )
    );
