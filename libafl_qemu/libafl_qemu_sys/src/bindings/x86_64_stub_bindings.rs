/* 1.88.0-nightly */
/* qemu git hash: 67a5a1a31ebfd36e9bafa99c72bafab81d19ae51 */
...
pub type libafl_qemu_on_signal_hdlr =
    ::std::option::Option<unsafe extern "C" fn(target_sig: ::std::os::raw::c_int)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
