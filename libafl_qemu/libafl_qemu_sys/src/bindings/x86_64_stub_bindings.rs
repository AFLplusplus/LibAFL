...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of __pthread_cond_s"][::core::mem::size_of::<__pthread_cond_s>() - 40usize];
...
pub const CpuS390Entitlement_S390_CPU_ENTITLEMENT_AUTO: CpuS390Entitlement = CpuS390Entitlement(0);
pub const CpuS390Entitlement_S390_CPU_ENTITLEMENT_LOW: CpuS390Entitlement = CpuS390Entitlement(1);
pub const CpuS390Entitlement_S390_CPU_ENTITLEMENT_MEDIUM: CpuS390Entitlement =
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct CpuS390Entitlement(pub ::std::os::raw::c_uint);
...
pub const SysEmuTarget_SYS_EMU_TARGET_CRIS: SysEmuTarget = SysEmuTarget(4);
pub const SysEmuTarget_SYS_EMU_TARGET_HPPA: SysEmuTarget = SysEmuTarget(5);
pub const SysEmuTarget_SYS_EMU_TARGET_I386: SysEmuTarget = SysEmuTarget(6);
pub const SysEmuTarget_SYS_EMU_TARGET_LOONGARCH64: SysEmuTarget = SysEmuTarget(7);
pub const SysEmuTarget_SYS_EMU_TARGET_M68K: SysEmuTarget = SysEmuTarget(8);
pub const SysEmuTarget_SYS_EMU_TARGET_MICROBLAZE: SysEmuTarget = SysEmuTarget(9);
pub const SysEmuTarget_SYS_EMU_TARGET_MICROBLAZEEL: SysEmuTarget = SysEmuTarget(10);
pub const SysEmuTarget_SYS_EMU_TARGET_MIPS: SysEmuTarget = SysEmuTarget(11);
pub const SysEmuTarget_SYS_EMU_TARGET_MIPS64: SysEmuTarget = SysEmuTarget(12);
pub const SysEmuTarget_SYS_EMU_TARGET_MIPS64EL: SysEmuTarget = SysEmuTarget(13);
pub const SysEmuTarget_SYS_EMU_TARGET_MIPSEL: SysEmuTarget = SysEmuTarget(14);
pub const SysEmuTarget_SYS_EMU_TARGET_OR1K: SysEmuTarget = SysEmuTarget(15);
pub const SysEmuTarget_SYS_EMU_TARGET_PPC: SysEmuTarget = SysEmuTarget(16);
pub const SysEmuTarget_SYS_EMU_TARGET_PPC64: SysEmuTarget = SysEmuTarget(17);
pub const SysEmuTarget_SYS_EMU_TARGET_RISCV32: SysEmuTarget = SysEmuTarget(18);
pub const SysEmuTarget_SYS_EMU_TARGET_RISCV64: SysEmuTarget = SysEmuTarget(19);
pub const SysEmuTarget_SYS_EMU_TARGET_RX: SysEmuTarget = SysEmuTarget(20);
pub const SysEmuTarget_SYS_EMU_TARGET_S390X: SysEmuTarget = SysEmuTarget(21);
pub const SysEmuTarget_SYS_EMU_TARGET_SH4: SysEmuTarget = SysEmuTarget(22);
pub const SysEmuTarget_SYS_EMU_TARGET_SH4EB: SysEmuTarget = SysEmuTarget(23);
pub const SysEmuTarget_SYS_EMU_TARGET_SPARC: SysEmuTarget = SysEmuTarget(24);
pub const SysEmuTarget_SYS_EMU_TARGET_SPARC64: SysEmuTarget = SysEmuTarget(25);
pub const SysEmuTarget_SYS_EMU_TARGET_TRICORE: SysEmuTarget = SysEmuTarget(26);
pub const SysEmuTarget_SYS_EMU_TARGET_X86_64: SysEmuTarget = SysEmuTarget(27);
...
pub const CpuS390State_S390_CPU_STATE_UNINITIALIZED: CpuS390State = CpuS390State(0);
pub const CpuS390State_S390_CPU_STATE_STOPPED: CpuS390State = CpuS390State(1);
pub const CpuS390State_S390_CPU_STATE_CHECK_STOP: CpuS390State = CpuS390State(2);
...
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct CpuS390State(pub ::std::os::raw::c_uint);
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: CPUNegativeOffsetState::icount_decr"]
        [::std::mem::offset_of!(CPUNegativeOffsetState, icount_decr) - 9384usize];
    ["Offset of field: CPUNegativeOffsetState::can_do_io"]
        [::std::mem::offset_of!(CPUNegativeOffsetState, can_do_io) - 9388usize];
};
...
pub const CPUTopoLevel_CPU_TOPO_LEVEL_INVALID: CPUTopoLevel = CPUTopoLevel(0);
pub const CPUTopoLevel_CPU_TOPO_LEVEL_SMT: CPUTopoLevel = CPUTopoLevel(1);
pub const CPUTopoLevel_CPU_TOPO_LEVEL_CORE: CPUTopoLevel = CPUTopoLevel(2);
pub const CPUTopoLevel_CPU_TOPO_LEVEL_MODULE: CPUTopoLevel = CPUTopoLevel(3);
...
pub type FeatureWordArray = [u64; 40usize];
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: CPUArchState::error_code"]
        [::std::mem::offset_of!(CPUArchState, error_code) - 13256usize];
    ["Offset of field: CPUArchState::exception_is_int"]
        [::std::mem::offset_of!(CPUArchState, exception_is_int) - 13260usize];
    ["Offset of field: CPUArchState::exception_next_eip"]
        [::std::mem::offset_of!(CPUArchState, exception_next_eip) - 13264usize];
    ["Offset of field: CPUArchState::dr"][::std::mem::offset_of!(CPUArchState, dr) - 13272usize];
    ["Offset of field: CPUArchState::old_exception"]
        [::std::mem::offset_of!(CPUArchState, old_exception) - 13368usize];
    ["Offset of field: CPUArchState::vm_vmcb"]
        [::std::mem::offset_of!(CPUArchState, vm_vmcb) - 13376usize];
    ["Offset of field: CPUArchState::tsc_offset"]
        [::std::mem::offset_of!(CPUArchState, tsc_offset) - 13384usize];
    ["Offset of field: CPUArchState::intercept"]
        [::std::mem::offset_of!(CPUArchState, intercept) - 13392usize];
    ["Offset of field: CPUArchState::intercept_cr_read"]
        [::std::mem::offset_of!(CPUArchState, intercept_cr_read) - 13400usize];
    ["Offset of field: CPUArchState::intercept_cr_write"]
        [::std::mem::offset_of!(CPUArchState, intercept_cr_write) - 13402usize];
    ["Offset of field: CPUArchState::intercept_dr_read"]
        [::std::mem::offset_of!(CPUArchState, intercept_dr_read) - 13404usize];
    ["Offset of field: CPUArchState::intercept_dr_write"]
        [::std::mem::offset_of!(CPUArchState, intercept_dr_write) - 13406usize];
    ["Offset of field: CPUArchState::intercept_exceptions"]
        [::std::mem::offset_of!(CPUArchState, intercept_exceptions) - 13408usize];
    ["Offset of field: CPUArchState::nested_cr3"]
        [::std::mem::offset_of!(CPUArchState, nested_cr3) - 13416usize];
    ["Offset of field: CPUArchState::nested_pg_mode"]
        [::std::mem::offset_of!(CPUArchState, nested_pg_mode) - 13424usize];
    ["Offset of field: CPUArchState::v_tpr"]
        [::std::mem::offset_of!(CPUArchState, v_tpr) - 13428usize];
    ["Offset of field: CPUArchState::int_ctl"]
        [::std::mem::offset_of!(CPUArchState, int_ctl) - 13432usize];
    ["Offset of field: CPUArchState::nmi_injected"]
        [::std::mem::offset_of!(CPUArchState, nmi_injected) - 13436usize];
    ["Offset of field: CPUArchState::nmi_pending"]
        [::std::mem::offset_of!(CPUArchState, nmi_pending) - 13437usize];
    ["Offset of field: CPUArchState::retaddr"]
        [::std::mem::offset_of!(CPUArchState, retaddr) - 13440usize];
    ["Offset of field: CPUArchState::msr_rapl_power_unit"]
        [::std::mem::offset_of!(CPUArchState, msr_rapl_power_unit) - 13448usize];
    ["Offset of field: CPUArchState::msr_pkg_energy_status"]
        [::std::mem::offset_of!(CPUArchState, msr_pkg_energy_status) - 13456usize];
    ["Offset of field: CPUArchState::end_reset_fields"]
        [::std::mem::offset_of!(CPUArchState, end_reset_fields) - 13464usize];
    ["Offset of field: CPUArchState::cpuid_level_func7"]
        [::std::mem::offset_of!(CPUArchState, cpuid_level_func7) - 13464usize];
    ["Offset of field: CPUArchState::cpuid_min_level_func7"]
        [::std::mem::offset_of!(CPUArchState, cpuid_min_level_func7) - 13468usize];
    ["Offset of field: CPUArchState::cpuid_min_level"]
        [::std::mem::offset_of!(CPUArchState, cpuid_min_level) - 13472usize];
    ["Offset of field: CPUArchState::cpuid_min_xlevel"]
        [::std::mem::offset_of!(CPUArchState, cpuid_min_xlevel) - 13476usize];
    ["Offset of field: CPUArchState::cpuid_min_xlevel2"]
        [::std::mem::offset_of!(CPUArchState, cpuid_min_xlevel2) - 13480usize];
    ["Offset of field: CPUArchState::cpuid_max_level"]
        [::std::mem::offset_of!(CPUArchState, cpuid_max_level) - 13484usize];
    ["Offset of field: CPUArchState::cpuid_max_xlevel"]
        [::std::mem::offset_of!(CPUArchState, cpuid_max_xlevel) - 13488usize];
    ["Offset of field: CPUArchState::cpuid_max_xlevel2"]
        [::std::mem::offset_of!(CPUArchState, cpuid_max_xlevel2) - 13492usize];
    ["Offset of field: CPUArchState::cpuid_level"]
        [::std::mem::offset_of!(CPUArchState, cpuid_level) - 13496usize];
    ["Offset of field: CPUArchState::cpuid_xlevel"]
        [::std::mem::offset_of!(CPUArchState, cpuid_xlevel) - 13500usize];
    ["Offset of field: CPUArchState::cpuid_xlevel2"]
        [::std::mem::offset_of!(CPUArchState, cpuid_xlevel2) - 13504usize];
    ["Offset of field: CPUArchState::cpuid_vendor1"]
        [::std::mem::offset_of!(CPUArchState, cpuid_vendor1) - 13508usize];
    ["Offset of field: CPUArchState::cpuid_vendor2"]
        [::std::mem::offset_of!(CPUArchState, cpuid_vendor2) - 13512usize];
    ["Offset of field: CPUArchState::cpuid_vendor3"]
        [::std::mem::offset_of!(CPUArchState, cpuid_vendor3) - 13516usize];
    ["Offset of field: CPUArchState::cpuid_version"]
        [::std::mem::offset_of!(CPUArchState, cpuid_version) - 13520usize];
    ["Offset of field: CPUArchState::features"]
        [::std::mem::offset_of!(CPUArchState, features) - 13528usize];
    ["Offset of field: CPUArchState::user_features"]
        [::std::mem::offset_of!(CPUArchState, user_features) - 13848usize];
    ["Offset of field: CPUArchState::cpuid_model"]
        [::std::mem::offset_of!(CPUArchState, cpuid_model) - 14168usize];
    ["Offset of field: CPUArchState::cache_info_cpuid2"]
        [::std::mem::offset_of!(CPUArchState, cache_info_cpuid2) - 14216usize];
    ["Offset of field: CPUArchState::cache_info_cpuid4"]
        [::std::mem::offset_of!(CPUArchState, cache_info_cpuid4) - 14248usize];
    ["Offset of field: CPUArchState::cache_info_amd"]
        [::std::mem::offset_of!(CPUArchState, cache_info_amd) - 14280usize];
    ["Offset of field: CPUArchState::mtrr_fixed"]
        [::std::mem::offset_of!(CPUArchState, mtrr_fixed) - 14312usize];
    ["Offset of field: CPUArchState::mtrr_deftype"]
        [::std::mem::offset_of!(CPUArchState, mtrr_deftype) - 14400usize];
    ["Offset of field: CPUArchState::mtrr_var"]
        [::std::mem::offset_of!(CPUArchState, mtrr_var) - 14408usize];
    ["Offset of field: CPUArchState::mp_state"]
        [::std::mem::offset_of!(CPUArchState, mp_state) - 14536usize];
    ["Offset of field: CPUArchState::exception_nr"]
        [::std::mem::offset_of!(CPUArchState, exception_nr) - 14540usize];
    ["Offset of field: CPUArchState::interrupt_injected"]
        [::std::mem::offset_of!(CPUArchState, interrupt_injected) - 14544usize];
    ["Offset of field: CPUArchState::soft_interrupt"]
        [::std::mem::offset_of!(CPUArchState, soft_interrupt) - 14548usize];
    ["Offset of field: CPUArchState::exception_pending"]
        [::std::mem::offset_of!(CPUArchState, exception_pending) - 14549usize];
    ["Offset of field: CPUArchState::exception_injected"]
        [::std::mem::offset_of!(CPUArchState, exception_injected) - 14550usize];
    ["Offset of field: CPUArchState::has_error_code"]
        [::std::mem::offset_of!(CPUArchState, has_error_code) - 14551usize];
    ["Offset of field: CPUArchState::exception_has_payload"]
        [::std::mem::offset_of!(CPUArchState, exception_has_payload) - 14552usize];
    ["Offset of field: CPUArchState::exception_payload"]
        [::std::mem::offset_of!(CPUArchState, exception_payload) - 14560usize];
    ["Offset of field: CPUArchState::triple_fault_pending"]
        [::std::mem::offset_of!(CPUArchState, triple_fault_pending) - 14568usize];
    ["Offset of field: CPUArchState::ins_len"]
        [::std::mem::offset_of!(CPUArchState, ins_len) - 14572usize];
    ["Offset of field: CPUArchState::sipi_vector"]
        [::std::mem::offset_of!(CPUArchState, sipi_vector) - 14576usize];
    ["Offset of field: CPUArchState::tsc_valid"]
        [::std::mem::offset_of!(CPUArchState, tsc_valid) - 14580usize];
    ["Offset of field: CPUArchState::tsc_khz"]
        [::std::mem::offset_of!(CPUArchState, tsc_khz) - 14584usize];
    ["Offset of field: CPUArchState::user_tsc_khz"]
        [::std::mem::offset_of!(CPUArchState, user_tsc_khz) - 14592usize];
    ["Offset of field: CPUArchState::apic_bus_freq"]
        [::std::mem::offset_of!(CPUArchState, apic_bus_freq) - 14600usize];
    ["Offset of field: CPUArchState::tsc"][::std::mem::offset_of!(CPUArchState, tsc) - 14608usize];
    ["Offset of field: CPUArchState::mcg_cap"]
        [::std::mem::offset_of!(CPUArchState, mcg_cap) - 14616usize];
    ["Offset of field: CPUArchState::mcg_ctl"]
        [::std::mem::offset_of!(CPUArchState, mcg_ctl) - 14624usize];
    ["Offset of field: CPUArchState::mcg_ext_ctl"]
        [::std::mem::offset_of!(CPUArchState, mcg_ext_ctl) - 14632usize];
    ["Offset of field: CPUArchState::mce_banks"]
        [::std::mem::offset_of!(CPUArchState, mce_banks) - 14640usize];
    ["Offset of field: CPUArchState::xstate_bv"]
        [::std::mem::offset_of!(CPUArchState, xstate_bv) - 14960usize];
    ["Offset of field: CPUArchState::fpus_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fpus_vmstate) - 14968usize];
    ["Offset of field: CPUArchState::fptag_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fptag_vmstate) - 14970usize];
    ["Offset of field: CPUArchState::fpregs_format_vmstate"]
        [::std::mem::offset_of!(CPUArchState, fpregs_format_vmstate) - 14972usize];
    ["Offset of field: CPUArchState::xss"][::std::mem::offset_of!(CPUArchState, xss) - 14976usize];
    ["Offset of field: CPUArchState::umwait"]
        [::std::mem::offset_of!(CPUArchState, umwait) - 14984usize];
    ["Offset of field: CPUArchState::tpr_access_type"]
        [::std::mem::offset_of!(CPUArchState, tpr_access_type) - 14988usize];
    ["Offset of field: CPUArchState::nr_dies"]
        [::std::mem::offset_of!(CPUArchState, nr_dies) - 14992usize];
    ["Offset of field: CPUArchState::nr_modules"]
        [::std::mem::offset_of!(CPUArchState, nr_modules) - 14996usize];
    ["Offset of field: CPUArchState::avail_cpu_topo"]
        [::std::mem::offset_of!(CPUArchState, avail_cpu_topo) - 15000usize];
};
...
const _: () = {
    ...
    ["Offset of field: ArchCPU::ucode_rev"]
        [::std::mem::offset_of!(ArchCPU, ucode_rev) - 25192usize];
    ["Offset of field: ArchCPU::hyperv_spinlock_attempts"]
        [::std::mem::offset_of!(ArchCPU, hyperv_spinlock_attempts) - 25200usize];
    ["Offset of field: ArchCPU::hyperv_vendor"]
        [::std::mem::offset_of!(ArchCPU, hyperv_vendor) - 25208usize];
    ["Offset of field: ArchCPU::hyperv_synic_kvm_only"]
        [::std::mem::offset_of!(ArchCPU, hyperv_synic_kvm_only) - 25216usize];
    ["Offset of field: ArchCPU::hyperv_features"]
        [::std::mem::offset_of!(ArchCPU, hyperv_features) - 25224usize];
    ["Offset of field: ArchCPU::hyperv_passthrough"]
        [::std::mem::offset_of!(ArchCPU, hyperv_passthrough) - 25232usize];
    ["Offset of field: ArchCPU::hyperv_no_nonarch_cs"]
        [::std::mem::offset_of!(ArchCPU, hyperv_no_nonarch_cs) - 25236usize];
    ["Offset of field: ArchCPU::hyperv_vendor_id"]
        [::std::mem::offset_of!(ArchCPU, hyperv_vendor_id) - 25240usize];
    ["Offset of field: ArchCPU::hyperv_interface_id"]
        [::std::mem::offset_of!(ArchCPU, hyperv_interface_id) - 25252usize];
    ["Offset of field: ArchCPU::hyperv_limits"]
        [::std::mem::offset_of!(ArchCPU, hyperv_limits) - 25268usize];
    ["Offset of field: ArchCPU::hyperv_enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, hyperv_enforce_cpuid) - 25280usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_build"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_build) - 25284usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_major"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_major) - 25288usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_minor"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_minor) - 25290usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sp"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sp) - 25292usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sb"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sb) - 25296usize];
    ["Offset of field: ArchCPU::hyperv_ver_id_sn"]
        [::std::mem::offset_of!(ArchCPU, hyperv_ver_id_sn) - 25300usize];
    ["Offset of field: ArchCPU::check_cpuid"]
        [::std::mem::offset_of!(ArchCPU, check_cpuid) - 25304usize];
    ["Offset of field: ArchCPU::enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, enforce_cpuid) - 25305usize];
    ["Offset of field: ArchCPU::force_features"]
        [::std::mem::offset_of!(ArchCPU, force_features) - 25306usize];
    ["Offset of field: ArchCPU::expose_kvm"]
        [::std::mem::offset_of!(ArchCPU, expose_kvm) - 25307usize];
    ["Offset of field: ArchCPU::expose_tcg"]
        [::std::mem::offset_of!(ArchCPU, expose_tcg) - 25308usize];
    ["Offset of field: ArchCPU::migratable"]
        [::std::mem::offset_of!(ArchCPU, migratable) - 25309usize];
    ["Offset of field: ArchCPU::migrate_smi_count"]
        [::std::mem::offset_of!(ArchCPU, migrate_smi_count) - 25310usize];
    ["Offset of field: ArchCPU::max_features"]
        [::std::mem::offset_of!(ArchCPU, max_features) - 25311usize];
    ["Offset of field: ArchCPU::apic_id"][::std::mem::offset_of!(ArchCPU, apic_id) - 25312usize];
    ["Offset of field: ArchCPU::vmware_cpuid_freq"]
        [::std::mem::offset_of!(ArchCPU, vmware_cpuid_freq) - 25316usize];
    ["Offset of field: ArchCPU::cache_info_passthrough"]
        [::std::mem::offset_of!(ArchCPU, cache_info_passthrough) - 25317usize];
    ["Offset of field: ArchCPU::mwait"][::std::mem::offset_of!(ArchCPU, mwait) - 25320usize];
    ...
    ["Offset of field: ArchCPU::enable_pmu"]
        [::std::mem::offset_of!(ArchCPU, enable_pmu) - 25656usize];
    ["Offset of field: ArchCPU::lbr_fmt"][::std::mem::offset_of!(ArchCPU, lbr_fmt) - 25664usize];
    ["Offset of field: ArchCPU::enable_lmce"]
        [::std::mem::offset_of!(ArchCPU, enable_lmce) - 25672usize];
    ["Offset of field: ArchCPU::enable_l3_cache"]
        [::std::mem::offset_of!(ArchCPU, enable_l3_cache) - 25673usize];
    ["Offset of field: ArchCPU::l1_cache_per_core"]
        [::std::mem::offset_of!(ArchCPU, l1_cache_per_core) - 25674usize];
    ["Offset of field: ArchCPU::legacy_cache"]
        [::std::mem::offset_of!(ArchCPU, legacy_cache) - 25675usize];
    ["Offset of field: ArchCPU::legacy_multi_node"]
        [::std::mem::offset_of!(ArchCPU, legacy_multi_node) - 25676usize];
    ["Offset of field: ArchCPU::enable_cpuid_0xb"]
        [::std::mem::offset_of!(ArchCPU, enable_cpuid_0xb) - 25677usize];
    ["Offset of field: ArchCPU::full_cpuid_auto_level"]
        [::std::mem::offset_of!(ArchCPU, full_cpuid_auto_level) - 25678usize];
    ["Offset of field: ArchCPU::vendor_cpuid_only"]
        [::std::mem::offset_of!(ArchCPU, vendor_cpuid_only) - 25679usize];
    ["Offset of field: ArchCPU::amd_topoext_features_only"]
        [::std::mem::offset_of!(ArchCPU, amd_topoext_features_only) - 25680usize];
    ["Offset of field: ArchCPU::intel_pt_auto_level"]
        [::std::mem::offset_of!(ArchCPU, intel_pt_auto_level) - 25681usize];
    ["Offset of field: ArchCPU::fill_mtrr_mask"]
        [::std::mem::offset_of!(ArchCPU, fill_mtrr_mask) - 25682usize];
    ["Offset of field: ArchCPU::host_phys_bits"]
        [::std::mem::offset_of!(ArchCPU, host_phys_bits) - 25683usize];
    ["Offset of field: ArchCPU::host_phys_bits_limit"]
        [::std::mem::offset_of!(ArchCPU, host_phys_bits_limit) - 25684usize];
    ["Offset of field: ArchCPU::kvm_pv_enforce_cpuid"]
        [::std::mem::offset_of!(ArchCPU, kvm_pv_enforce_cpuid) - 25685usize];
    ["Offset of field: ArchCPU::phys_bits"]
        [::std::mem::offset_of!(ArchCPU, phys_bits) - 25688usize];
    ["Offset of field: ArchCPU::guest_phys_bits"]
        [::std::mem::offset_of!(ArchCPU, guest_phys_bits) - 25692usize];
    ["Offset of field: ArchCPU::apic_state"]
        [::std::mem::offset_of!(ArchCPU, apic_state) - 25696usize];
    ["Offset of field: ArchCPU::cpu_as_root"]
        [::std::mem::offset_of!(ArchCPU, cpu_as_root) - 25704usize];
    ["Offset of field: ArchCPU::cpu_as_mem"]
        [::std::mem::offset_of!(ArchCPU, cpu_as_mem) - 25712usize];
    ["Offset of field: ArchCPU::smram"][::std::mem::offset_of!(ArchCPU, smram) - 25720usize];
    ["Offset of field: ArchCPU::machine_done"]
        [::std::mem::offset_of!(ArchCPU, machine_done) - 25728usize];
    ["Offset of field: ArchCPU::kvm_msr_buf"]
        [::std::mem::offset_of!(ArchCPU, kvm_msr_buf) - 25752usize];
    ["Offset of field: ArchCPU::node_id"][::std::mem::offset_of!(ArchCPU, node_id) - 25760usize];
    ["Offset of field: ArchCPU::socket_id"]
        [::std::mem::offset_of!(ArchCPU, socket_id) - 25764usize];
    ["Offset of field: ArchCPU::die_id"][::std::mem::offset_of!(ArchCPU, die_id) - 25768usize];
    ["Offset of field: ArchCPU::module_id"]
        [::std::mem::offset_of!(ArchCPU, module_id) - 25772usize];
    ["Offset of field: ArchCPU::core_id"][::std::mem::offset_of!(ArchCPU, core_id) - 25776usize];
    ["Offset of field: ArchCPU::thread_id"]
        [::std::mem::offset_of!(ArchCPU, thread_id) - 25780usize];
    ["Offset of field: ArchCPU::hv_max_vps"]
        [::std::mem::offset_of!(ArchCPU, hv_max_vps) - 25784usize];
    ["Offset of field: ArchCPU::xen_vapic"]
        [::std::mem::offset_of!(ArchCPU, xen_vapic) - 25788usize];
};
...
pub type libafl_backdoor_exec_cb = ::core::option::Option<
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libafl_backdoor_hook"][::core::mem::size_of::<libafl_backdoor_hook>() - 112usize];
...
pub type libafl_block_pre_gen_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, pc: target_ulong) -> u64>;
pub type libafl_block_post_gen_cb = ::core::option::Option<
    unsafe extern "C" fn(data: u64, pc: target_ulong, block_length: target_ulong),
>;
pub type libafl_block_exec_cb = ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64)>;
pub type libafl_block_jit_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64) -> usize>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type libafl_cmp_gen_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, pc: target_ulong, size: usize) -> u64>;
pub type libafl_cmp_exec1_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64, v0: u8, v1: u8)>;
pub type libafl_cmp_exec2_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64, v0: u16, v1: u16)>;
pub type libafl_cmp_exec4_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64, v0: u32, v1: u32)>;
pub type libafl_cmp_exec8_cb =
    ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64, v0: u64, v1: u64)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type libafl_edge_gen_cb = ::core::option::Option<
    unsafe extern "C" fn(data: u64, src: target_ulong, dst: target_ulong) -> u64,
>;
pub type libafl_edge_exec_cb = ::core::option::Option<unsafe extern "C" fn(data: u64, id: u64)>;
