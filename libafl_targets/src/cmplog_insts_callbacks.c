...
void __cmplog_ins_hook8_ctx_extended(uint32_t ctx, uint64_t arg1, uint64_t arg2,
                                     uint8_t attr) {
  if (!libafl_cmplog_enabled) { return; }
  libafl_cmplog_enabled = false;
  uintptr_t k = RETADDR;
...
void __cmplog_ins_hook16_ctx_extended(uint32_t ctx, uint128_t arg1,
...
void __cmplog_ins_hookN_ctx_extended(uint32_t ctx, uint128_t arg1,
                                     uint128_t arg2, uint8_t attr,
                                     uint8_t size) {
  if (!libafl_cmplog_enabled) { return; }
  libafl_cmplog_enabled = false;
