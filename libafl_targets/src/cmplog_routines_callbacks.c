...
void __cmplog_rtn_hook_ctx(uint32_t ctx, const uint8_t *ptr1,
                           const uint8_t *ptr2) {
  if (!libafl_cmplog_enabled) { return; }
...
void __cmplog_rtn_hook_ctx_extended(uint32_t ctx, const uint8_t *ptr1,
                                    const uint8_t *ptr2) {
  if (!libafl_cmplog_enabled) { return; }
...
void __cmplog_rtn_hook_n_ctx(uint32_t ctx, const uint8_t *ptr1,
  ...
  (void)(len);
  __cmplog_rtn_hook_ctx(ctx, ptr1, ptr2);
}
void __cmplog_rtn_hook_n_ctx_extended(uint32_t ctx, const uint8_t *ptr1,
                                      const uint8_t *ptr2, uint64_t len) {
  (void)(len);
  __cmplog_rtn_hook_ctx_extended(ctx, ptr1, ptr2);
}
...
void __cmplog_rtn_gcc_stdstring_cstring_ctx(uint32_t       ctx,
...
void __cmplog_rtn_gcc_stdstring_stdstring_ctx(uint32_t       ctx,
                                              const uint8_t *stdstring1,
                                              const uint8_t *stdstring2) {
  if (!libafl_cmplog_enabled) { return; }
...
void __cmplog_rtn_gcc_stdstring_stdstring_ctx_extended(
    uint32_t ctx, const uint8_t *stdstring1, const uint8_t *stdstring2) {
  if (!libafl_cmplog_enabled) { return; }
...
void __cmplog_rtn_llvm_stdstring_cstring_ctx(uint32_t       ctx,
                                             const uint8_t *stdstring,
                                             const uint8_t *cstring) {
  if (!libafl_cmplog_enabled) { return; }
...
void __cmplog_rtn_llvm_stdstring_stdstring_ctx_extended(
    uint32_t ctx, const uint8_t *stdstring1, const uint8_t *stdstring2) {
  if (!libafl_cmplog_enabled) { return; }
