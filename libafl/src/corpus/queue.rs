...
#[derive(Debug, Clone)]
pub struct QueueCorpusScheduler<S>
where
    S: HasCorpus,
{
...
impl<S> CorpusScheduler for QueueCorpusScheduler<S>
where
    S: HasCorpus,
{
    type State = S;
...
impl<S> Default for QueueCorpusScheduler<S>
where
    S: HasCorpus,
{
    fn default() -> Self {
