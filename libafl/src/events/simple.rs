...
#[cfg(feature = "std")]
impl<MT, S, SP> Deref for SimpleRestartingEventManager<MT, S, SP>
where
    S: HasCorpus,
    SP: ShMemProvider,
{
    type Target = SimpleEventManager<MT, S>;
...
#[cfg(feature = "std")]
impl<MT, S, SP> DerefMut for SimpleRestartingEventManager<MT, S, SP>
where
    S: HasCorpus,
    SP: ShMemProvider,
{
...
where
    MT: Monitor,
    S: HasCorpus + Serialize + HasCurrentStage,
    SP: ShMemProvider,
{
