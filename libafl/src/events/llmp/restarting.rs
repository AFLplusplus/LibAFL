...
where
    S: HasExecutions + HasMetadata + HasLastReportTime + HasCorpus + Serialize,
    <<S as HasCorpus>::Corpus as Corpus>::Input: Serialize,
    SP: ShMemProvider,
{
...
impl<EMH, S, SP> EventFirer<<S::Corpus as Corpus>::Input, S>
    for LlmpRestartingEventManager<EMH, S, SP>
where
    SP: ShMemProvider,
    <<S as HasCorpus>::Corpus as Corpus>::Input: Serialize,
...
where
    S: HasExecutions + HasCurrentStage + Serialize,
    SP: ShMemProvider,
    //CE: CustomEvent<I>,
{
...
where
    ...
    S::Corpus: Serialize,
    Z: Evaluator<E, LlmpEventManager<EMH, S, SP>, <S::Corpus as Corpus>::Input, S>
