...
impl<'a, SP> ForkserverExecutorBuilder<'a, SP> {
    ...
    ///
    /// **Do not** put in the path to the program, unless you want it to be passed to the
    /// program as argument 1! The program path has to be set using
    /// [`program()`](ForkserverExecutorBuilder::program)
