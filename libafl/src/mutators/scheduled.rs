...
#[cfg(feature = "python")]
/// `StdScheduledMutator` Python bindings
pub mod pybind {
    ...
    macro_rules! define_python_std_scheduled_mutator {
        ($struct_name:ident, $py_name:tt, $my_std_state_type_name: ident) => {
            ...
            #[derive(Debug)]
            /// Python class for StdScheduledMutator
            pub struct $struct_name {
                /// Rust wrapped StdScheduledMutator object
                pub std_scheduled_mutator:
            ...
            impl $struct_name {
                #[new]
                fn new_from_havoc_mutations() -> Self {
                    Self {
                        std_scheduled_mutator: StdScheduledMutator::new(havoc_mutations()),
                    }
                }
            }
        };
    ...
    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorI8,
        "StdScheduledMutatorI8",
        MyStdStateI8
    );

    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorI16,
        "StdScheduledMutatorI16",
        MyStdStateI16
    );
    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorI32,
        "StdScheduledMutatorI32",
        MyStdStateI32
    );
    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorI64,
        "StdScheduledMutatorI64",
        MyStdStateI64
    );

    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorU8,
        "StdScheduledMutatorU8",
        MyStdStateU8
    );

    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorU16,
        "StdScheduledMutatorU16",
        MyStdStateU16
    );
    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorU32,
        "StdScheduledMutatorU32",
        MyStdStateU32
    );
    define_python_std_scheduled_mutator!(
        PythonStdScheduledMutatorU64,
        "StdScheduledMutatorU64",
        MyStdStateU64
    );

    /// Register the classes to the python module
    pub fn register(_py: Python, m: &PyModule) -> PyResult<()> {
        m.add_class::<PythonStdScheduledMutatorI8>()?;
        m.add_class::<PythonStdScheduledMutatorI16>()?;
        m.add_class::<PythonStdScheduledMutatorI32>()?;
        m.add_class::<PythonStdScheduledMutatorI64>()?;

        m.add_class::<PythonStdScheduledMutatorU8>()?;
        m.add_class::<PythonStdScheduledMutatorU16>()?;
        m.add_class::<PythonStdScheduledMutatorU32>()?;
        m.add_class::<PythonStdScheduledMutatorU64>()?;
        Ok(())
    }
}
