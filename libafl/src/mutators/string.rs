...
use crate::{
    ...
    stages::string::{PropertyRanges, StringPropertiesStage, SubpropertyRanges},
    state::{HasMaxSize, HasRand},
};

pub type UnicodeInput = (BytesInput, (PropertyRanges, SubpropertyRanges));
