...
/// A stage that runs a tracer executor fpor dataflow infearence
#[derive(Clone, Debug)]
pub struct DataflowInfearenceStage<C, EM, I, OT, S, TE, Z>
where
    I: Input + HasBytesVec,
    C: Corpus<I>,
...
impl<E, C, EM, I, OT, S, TE, Z> Stage<E, EM, S, Z> for DataflowInfearenceStage<C, EM, I, OT, S, TE, Z>
where
    I: Input + HasBytesVec,
    C: Corpus<I>,
    TE: Executor<EM, I, S, Z> + HasObservers<I, OT, S>,
    ...
    S: HasClientPerfStats + HasExecutions + HasCorpus<C, I>,
{
    ...
    fn perform(
        ...
        *state.executions_mut() += 1;
        ...
        let original = self.tracer_executor.observers().get::<CO>()?.clone();
...
impl<C, EM, I, OT, S, TE, Z> DataflowInfearenceStage<C, EM, I, OT, S, TE, Z>
where
    I: Input + HasBytesVec,
    C: Corpus<I>,
    TE: Executor<EM, I, S, Z> + HasObservers<I, OT, S>,
...
#[derive(Clone, Debug)]
pub struct ShadowDataflowInfearenceStage<C, E, EM, I, OT, S, SOT, Z> {
    #[allow(clippy::type_complexity)]
    phantom: PhantomData<(C, E, EM, I, OT, S, SOT, Z)>,
}

impl<C, E, EM, I, OT, S, SOT, Z> Stage<ShadowExecutor<E, I, S, SOT>, EM, S, Z>
    for ShadowDataflowInfearenceStage<C, E, EM, I, OT, S, SOT, Z>
where
    I: Input + HasBytesVec,
    C: Corpus<I>,
...
impl<C, E, EM, I, OT, S, SOT, Z> ShadowDataflowInfearenceStage<C, E, EM, I, OT, S, SOT, Z>
where
    I: Input + HasBytesVec,
    C: Corpus<I>,
    E: Executor<EM, I, S, Z> + HasObservers<I, OT, S>,
