...
impl<I, M> Named for StdMutationalStage<I, M> {
...
#[derive(Clone, Debug)]
pub struct MultiMutationalStage<I, M> {
    name: Cow<'static, str>,
    mutator: M,
...
impl<I, M> Named for MultiMutationalStage<I, M> {
    fn name(&self) -> &Cow<'static, str> {
        &self.name
    }
}
...
impl<I, M> MultiMutationalStage<I, M> {
